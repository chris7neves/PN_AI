Attribute VB_Name = "PNUpdate_ALL"
Sub upload_database_all()
...
Function Header_Duplicate_all(NAME As String, AGE As Integer, GENDER As String, NOTES As String) As String
