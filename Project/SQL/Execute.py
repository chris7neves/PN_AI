import Data_Extract
from Project import filesystem

P1 = Data_Extract.SQLDatabase(filesystem.os.environ["PNAI_SERVER"],
...
Eye_Tracker_Data_For_One_Sheet = P1.eye_tracker_data(Trials_From_One_Excel_File[0][0])  # Call EyeTrackerData with T_AUTO
